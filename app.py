...
def main():
    stream.set_page_config(page_title = "Mutlimodal AI Chat App", page_icon = "🌼")
    ...
    user_input = stream.text_input("Query the Bot here...", key = "user_input", on_change = set_send_input)
